...
#define RK3562_GRF_SOC_STATUS0	0x510

enum rk3562_pmu_plls {
	ppll, hpll,
};
...
#define RK3562_DIV_ATCLK_CORE_MASK	0x1f
#define RK3562_DIV_ATCLK_CORE_SHIFT	0
#define RK3562_DIV_GICCLK_CORE_MASK	0x1f
#define RK3562_DIV_GICCLK_CORE_SHIFT	8
#define RK3562_DIV_PCLK_CORE_MASK	0x1f
#define RK3562_DIV_PCLK_CORE_SHIFT	0
#define RK3562_DIV_PERIPHCLK_CORE_MASK	0x1f
#define RK3562_DIV_PERIPHCLK_CORE_SHIFT	8
#define RK3562_DIV_ACLK_CORE_MASK	0x1f
#define RK3562_DIV_ACLK_CORE_SHIFT	8

#define RK3562_DIV_SCLK_CORE_MASK	0xf
#define RK3562_DIV_SCLK_CORE_SHIFT	0
#define RK3562_MUX_SCLK_CORE_MASK	0x3
#define RK3562_MUX_SCLK_CORE_SHIFT	8
#define RK3562_MUX_SCLK_CORE_NPLL_MASK	0x1
#define RK3562_MUX_SCLK_CORE_NPLL_SHIFT	15
#define RK3562_MUX_CLK_CORE_APLL_MASK	0x1
#define RK3562_MUX_CLK_CORE_APLL_SHIFT	7
#define RK3562_MUX_CLK_PVTPLL_MASK	0x1
#define RK3562_MUX_CLK_PVTPLL_SHIFT	15

#define RK3562_CLKSEL1(_sclk_core)					\
{								\
	.reg = RK3562_CLKSEL_CON(2),				\
	.val = HIWORD_UPDATE(_sclk_core, RK3562_MUX_SCLK_CORE_NPLL_MASK, \
			RK3562_MUX_SCLK_CORE_NPLL_SHIFT) |		\
	       HIWORD_UPDATE(_sclk_core, RK3562_MUX_SCLK_CORE_MASK, \
			RK3562_MUX_SCLK_CORE_SHIFT) |		\
		HIWORD_UPDATE(1, RK3562_DIV_SCLK_CORE_MASK, \
			RK3562_DIV_SCLK_CORE_SHIFT),		\
}

#define RK3562_CLKSEL2(_aclk_core)					\
{								\
	.reg = RK3562_CLKSEL_CON(5),				\
	.val = HIWORD_UPDATE(_aclk_core, RK3562_DIV_ACLK_CORE_MASK, \
			RK3562_DIV_ACLK_CORE_SHIFT),		\
}

#define RK3562_CLKSEL3(_atclk_core, _gic_core)	\
{								\
	.reg = RK3562_CLKSEL_CON(3),				\
	.val = HIWORD_UPDATE(_atclk_core, RK3562_DIV_ATCLK_CORE_MASK, \
			RK3562_DIV_ATCLK_CORE_SHIFT) |		\
	       HIWORD_UPDATE(_gic_core, RK3562_DIV_GICCLK_CORE_MASK, \
			RK3562_DIV_GICCLK_CORE_SHIFT),		\
}

#define RK3562_CLKSEL4(_pclk_core, _periph_core)	\
{								\
	.reg = RK3562_CLKSEL_CON(4),				\
	.val = HIWORD_UPDATE(_pclk_core, RK3562_DIV_PCLK_CORE_MASK, \
			RK3562_DIV_PCLK_CORE_SHIFT) |		\
	       HIWORD_UPDATE(_periph_core, RK3562_DIV_PERIPHCLK_CORE_MASK, \
			RK3562_DIV_PERIPHCLK_CORE_SHIFT),		\
}

#define RK3562_CPUCLK_RATE(_prate, _sclk, _acore, _atcore, _gicclk, _pclk, _periph) \
{								\
	.prate = _prate##U,					\
	.divs = {						\
		RK3562_CLKSEL1(_sclk),				\
		RK3562_CLKSEL2(_acore),				\
		RK3562_CLKSEL3(_atcore, _gicclk),		\
		RK3562_CLKSEL4(_pclk, _periph),			\
	},							\
}

static struct rockchip_cpuclk_rate_table rk3562_cpuclk_rates[] __initdata = {
	RK3562_CPUCLK_RATE(1800000000, 0, 1, 7, 7, 7, 7),
	RK3562_CPUCLK_RATE(1704000000, 0, 1, 7, 7, 7, 7),
	RK3562_CPUCLK_RATE(1608000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1584000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1560000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1536000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1512000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1488000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1464000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1440000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1416000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1392000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1368000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1344000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1320000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1296000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1272000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1248000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1224000000, 0, 1, 5, 5, 5, 5),
	RK3562_CPUCLK_RATE(1200000000, 0, 1, 3, 3, 3, 3),
	RK3562_CPUCLK_RATE(1104000000, 0, 1, 3, 3, 3, 3),
	RK3562_CPUCLK_RATE(1008000000, 0, 1, 3, 3, 3, 3),
	RK3562_CPUCLK_RATE(912000000, 0, 1, 3, 3, 3, 3),
	RK3562_CPUCLK_RATE(816000000, 0, 1, 3, 3, 3, 3),
	RK3562_CPUCLK_RATE(696000000, 0, 1, 3, 3, 3, 3),
	RK3562_CPUCLK_RATE(600000000, 0, 1, 3, 3, 3, 3),
	RK3562_CPUCLK_RATE(408000000, 0, 1, 3, 3, 3, 3),
	RK3562_CPUCLK_RATE(312000000, 0, 1, 3, 3, 3, 3),
	RK3562_CPUCLK_RATE(216000000, 0, 1, 3, 3, 3, 3),
	RK3562_CPUCLK_RATE(96000000, 0, 1, 3, 3, 3, 3),
};

static const struct rockchip_cpuclk_reg_data rk3562_cpuclk_data = {
	.core_reg[0] = RK3562_CLKSEL_CON(0),
	.div_core_shift[0] = 0,
	.div_core_mask[0] = 0x1f,
	.core_reg[1] = RK3562_CLKSEL_CON(0),
	.div_core_shift[1] = 8,
	.div_core_mask[1] = 0x1f,
	.core_reg[2] = RK3562_CLKSEL_CON(1),
	.div_core_shift[2] = 0,
	.div_core_mask[2] = 0x1f,
	.core_reg[3] = RK3562_CLKSEL_CON(1),
	.div_core_shift[3] = 8,
...
static struct rockchip_pll_clock rk3562_pmu_pll_clks[] __initdata = {
	[ppll] = PLL(pll_rk3328, PLL_PPLL, "ppll",  mux_pll_p,
		     0, RK3562_PMU_PLL_CON(0),
		     RK3562_PMU_MODE_CON0, 0, 4, 0, rk3562_pll_rates),
	[hpll] = PLL(pll_rk3328, PLL_HPLL, "hpll",  mux_pll_p,
		     0, RK3562_PMU_PLL_CON(16),
		     RK3562_PMU_MODE_CON0, 2, 7, 0, rk3562_pll_rates),
};

static struct rockchip_pll_clock rk3562_pll_clks[] __initdata = {
	[apll] = PLL(pll_rk3328, PLL_APLL, "apll", mux_pll_p,
		     0, RK3562_PLL_CON(0),
		     RK3562_MODE_CON0, 0, 0, 0, rk3562_pll_rates),
	[dpll] = PLL(pll_rk3328, PLL_DPLL, "dpll", mux_pll_p,
		     0, RK3562_PLL_CON(8),
		     RK3562_MODE_CON0, 2, 1, 0, NULL),
	[cpll] = PLL(pll_rk3328, PLL_CPLL, "cpll", mux_pll_p,
		     0, RK3562_PLL_CON(24),
		     RK3562_MODE_CON0, 4, 2, 0, rk3562_pll_rates),
	[gpll] = PLL(pll_rk3328, PLL_GPLL, "gpll", mux_pll_p,
		     0, RK3562_PLL_CON(16),
		     RK3562_MODE_CON0, 6, 3, 0, rk3562_pll_rates),
	[npll] = PLL(pll_rk3328, PLL_NPLL, "npll", mux_pll_p,
		     0, RK3562_PLL_CON(32),
		     RK3562_MODE_CON0, 10, 5, 0, rk3562_pll_rates),
	[vpll] = PLL(pll_rk3328, PLL_VPLL, "vpll", mux_pll_p,
		     0, RK3562_PLL_CON(40),
		     RK3562_MODE_CON0, 12, 6, 0, rk3562_pll_rates),
};
...
static struct rockchip_clk_branch rk3562_i2s0_8ch_tx_fracmux __initdata =
	MUX(CLK_I2S0_8CH_TX, "clk_i2s0_8ch_tx", clk_i2s0_8ch_tx_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(11), 10, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_i2s0_8ch_rx_fracmux __initdata =
	MUX(CLK_I2S0_8CH_RX, "clk_i2s0_8ch_rx", clk_i2s0_8ch_rx_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(13), 10, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_i2s1_8ch_tx_fracmux __initdata =
	MUX(CLK_I2S1_8CH_TX, "clk_i2s1_8ch_tx", clk_i2s1_8ch_tx_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(15), 10, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_i2s1_8ch_rx_fracmux __initdata =
	MUX(CLK_I2S1_8CH_RX, "clk_i2s1_8ch_rx", clk_i2s1_8ch_rx_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(17), 10, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_i2s2_2ch_fracmux __initdata =
	MUX(CLK_I2S2_2CH, "clk_i2s2_2ch", clk_i2s2_2ch_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(19), 10, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_i2s3_2ch_tx_fracmux __initdata =
	MUX(CLK_I2S3_2CH_TX, "clk_i2s3_2ch_tx", clk_i2s3_2ch_tx_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(21), 10, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_i2s3_2ch_rx_fracmux __initdata =
	MUX(CLK_I2S3_2CH_RX, "clk_i2s3_2ch_rx", clk_i2s3_2ch_rx_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(83), 10, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_spdif_8ch_fracmux __initdata =
	MUX(MCLK_SPDIF_8CH, "mclk_spdif_8ch", mclk_spdif_8ch_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(23), 15, 1, MFLAGS);

static struct rockchip_clk_branch rk3562_audpwm_fracmux __initdata =
	MUX(SCLK_AUDPWM, "sclk_audpwm", sclk_audpwm_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(25), 15, 1, MFLAGS);

static struct rockchip_clk_branch rk3562_uart1_fracmux __initdata =
	MUX(0, "sclk_uart1_mux", sclk_uart1_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(52), 12, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_uart2_fracmux __initdata =
	MUX(0, "sclk_uart2_mux", sclk_uart2_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(54), 12, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_uart3_fracmux __initdata =
	MUX(0, "sclk_uart3_mux", sclk_uart3_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(56), 12, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_uart4_fracmux __initdata =
	MUX(0, "sclk_uart4_mux", sclk_uart4_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(58), 12, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_uart5_fracmux __initdata =
	MUX(0, "sclk_uart5_mux", sclk_uart5_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(60), 12, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_uart6_fracmux __initdata =
	MUX(0, "sclk_uart6_mux", sclk_uart6_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(62), 12, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_uart7_fracmux __initdata =
	MUX(0, "sclk_uart7_mux", sclk_uart7_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(64), 12, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_uart8_fracmux __initdata =
	MUX(0, "sclk_uart8_mux", sclk_uart8_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(66), 12, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_uart9_fracmux __initdata =
	MUX(0, "sclk_uart9_mux", sclk_uart9_p, CLK_SET_RATE_PARENT,
			RK3562_CLKSEL_CON(68), 12, 2, MFLAGS);

static struct rockchip_clk_branch rk3562_uart0_fracmux __initdata =
	MUX(0, "sclk_uart0_mux", sclk_uart0_p, CLK_SET_RATE_PARENT,
			RK3562_PMU_CLKSEL_CON(4), 10, 2, MFLAGS);
...
static struct rockchip_clk_branch rk3562_rtc32k_pmu_fracmux __initdata =
	MUX(CLK_RTC_32K, "clk_rtc_32k", clk_rtc32k_pmu_p, CLK_SET_RATE_PARENT | CLK_SET_RATE_NO_REPARENT,
			RK3562_PMU_CLKSEL_CON(0), 6, 2, MFLAGS);
...
static struct rockchip_clk_branch rk3562_clk_branches[] __initdata = {
	...
	COMPOSITE_NOMUX(0, "gpll_400m", "gpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(75), 0, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 0, GFLAGS),
	COMPOSITE_NOMUX(0, "gpll_300m", "gpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(75), 8, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 1, GFLAGS),
	COMPOSITE_NOMUX(0, "gpll_200m", "gpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(76), 0, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 2, GFLAGS),
	COMPOSITE_NOMUX(0, "gpll_150m", "gpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(76), 8, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 3, GFLAGS),
	COMPOSITE_NOMUX(0, "gpll_100m", "gpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(77), 0, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 4, GFLAGS),
	COMPOSITE_NOMUX(0, "gpll_75m", "gpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(77), 8, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 5, GFLAGS),
	COMPOSITE_NOMUX(0, "gpll_20m", "gpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(78), 0, 6, DFLAGS,
			RK3562_CLKGATE_CON(35), 6, GFLAGS),
	COMPOSITE_NOMUX(CPLL_500M, "cpll_500m", "cpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(78), 8, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 7, GFLAGS),
	COMPOSITE_NOMUX(CPLL_333M, "cpll_333m", "cpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(79), 0, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 8, GFLAGS),
	COMPOSITE_NOMUX(CPLL_250M, "cpll_250m", "cpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(79), 8, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 9, GFLAGS),
	COMPOSITE_NOMUX(CPLL_125M, "cpll_125m", "cpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(80), 0, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 10, GFLAGS),
	COMPOSITE_NOMUX(CPLL_100M, "cpll_100m", "cpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(82), 0, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 11, GFLAGS),
	COMPOSITE_NOMUX(CPLL_62P5M, "cpll_62p5", "cpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(80), 8, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 12, GFLAGS),
	COMPOSITE_NOMUX(CPLL_50M, "cpll_50m", "cpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(81), 0, 5, DFLAGS,
			RK3562_CLKGATE_CON(35), 13, GFLAGS),
	COMPOSITE_NOMUX(CPLL_25M, "cpll_25m", "cpll", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(81), 8, 6, DFLAGS,
			RK3562_CLKGATE_CON(35), 14, GFLAGS),
	COMPOSITE_NOMUX(0, "clk_osc0_div_750k", "xin24m", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(82), 8, 6, DFLAGS,
			RK3562_CLKGATE_CON(35), 15, GFLAGS),
	FACTOR(0, "clk_osc0_div_375k", "clk_osc0_div_750k", 0, 1, 2),
	FACTOR(0, "xin_osc0_half", "xin24m", 0, 1, 2),
	MUX(USB480M, "usb480m", mux_usb480m_p, CLK_SET_RATE_PARENT,
			RK3562_MODE_CON0, 14, 2, MFLAGS),

	/* PD_CORE */
	COMPOSITE(0, "sclk_core_src", apll_gpll_npll_p, CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(2), 8, 2, MFLAGS, 0, 4, DFLAGS | CLK_DIVIDER_READ_ONLY,
			RK3562_CLKGATE_CON(0), 5, GFLAGS),
	COMPOSITE_NODIV(0, "sclk_core", sclk_core_pre_p, CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(2), 15, 1, MFLAGS,
			RK3562_CLKGATE_CON(0), 7, GFLAGS),

	COMPOSITE_NOMUX(0, "atclk_core", "armclk", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(3), 0, 5, DFLAGS | CLK_DIVIDER_READ_ONLY,
			RK3562_CLKGATE_CON(0), 8, GFLAGS),
	COMPOSITE_NOMUX(0, "gicclk_core", "armclk", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(3), 8, 5, DFLAGS | CLK_DIVIDER_READ_ONLY,
			RK3562_CLKGATE_CON(0), 9, GFLAGS),
	COMPOSITE_NOMUX(0, "pclk_core_pre", "armclk", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(4), 0, 5, DFLAGS | CLK_DIVIDER_READ_ONLY,
			RK3562_CLKGATE_CON(0), 10, GFLAGS),
	COMPOSITE_NOMUX(0, "periphclk_core_pre", "armclk", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(4), 8, 5, DFLAGS | CLK_DIVIDER_READ_ONLY,
			RK3562_CLKGATE_CON(0), 11, GFLAGS),
	COMPOSITE_NOMUX(0, "tsclk_core", "periphclk_core_pre", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(5), 0, 4, DFLAGS | CLK_DIVIDER_READ_ONLY,
			RK3562_CLKGATE_CON(0), 14, GFLAGS),
	COMPOSITE_NOMUX(0, "cntclk_core", "periphclk_core_pre", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(5), 4, 4, DFLAGS | CLK_DIVIDER_READ_ONLY,
			RK3562_CLKGATE_CON(0), 15, GFLAGS),
	COMPOSITE_NOMUX(0, "aclk_core", "sclk_core", CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(5), 8, 5, DFLAGS | CLK_DIVIDER_READ_ONLY,
	...
	COMPOSITE_NODIV(ACLK_CORE_NIU2BUS, "aclk_core_niu2bus", gpll150_gpll100_gpll75_xin24m_p, CLK_IGNORE_UNUSED,
			RK3562_CLKSEL_CON(5), 14, 2, MFLAGS,
			RK3562_CLKGATE_CON(1), 2, GFLAGS),

	GATE(CLK_CORE_PVTM, "clk_core_pvtm", "xin24m", 0,
			RK3562_CLKGATE_CON(1), 10, GFLAGS),
	GATE(CLK_CORE_PVTM_CORE, "clk_core_pvtm_core", "armclk", 0,
			RK3562_CLKGATE_CON(1), 11, GFLAGS),
	...
	COMPOSITE_NODIV(NCLK_NANDC, "nclk_nandc", clk_nandc_p, 0,
			RK3562_CLKSEL_CON(28), 0, 2, MFLAGS,
	...
	GATE(HCLK_SFC_XIP, "hclk_sfc_xip", "hclk_secure_flash", 0,
			RK3562_CLKGATE_CON(9), 3, GFLAGS),
	COMPOSITE_NODIV(SCLK_SFC, "sclk_sfc", sclk_sfc_p, 0,
			RK3562_CLKSEL_CON(28), 4, 3, MFLAGS,
			RK3562_CLKGATE_CON(9), 4, GFLAGS),
	...
	COMPOSITE_NODIV(BCLK_EMMC, "bclk_emmc", gpll200_gpll150_cpll125_p, 0,
			RK3562_CLKSEL_CON(28), 8, 2, MFLAGS,
			RK3562_CLKGATE_CON(9), 7, GFLAGS),
	COMPOSITE_NODIV(CCLK_EMMC, "cclk_emmc", cclk_emmc_p, 0,
			RK3562_CLKSEL_CON(28), 12, 3, MFLAGS,
			RK3562_CLKGATE_CON(9), 8, GFLAGS),
	GATE(TCLK_EMMC, "tclk_emmc", "xin24m", 0,
			RK3562_CLKGATE_CON(9), 9, GFLAGS),
	MMC(SCLK_EMMC_DRV, "emmc_drv", "cclk_emmc", RK3562_EMMC_CON0, 1),
	MMC(SCLK_EMMC_SAMPLE, "emmc_sample", "cclk_emmc", RK3562_EMMC_CON1, 1),

	/* PD_PIPE */
	COMPOSITE_NODIV(ACLK_PIPE, "aclk_pipe", aclk_pipe_p, 0,
			RK3562_CLKSEL_CON(29), 0, 2, MFLAGS,
			RK3562_CLKGATE_CON(10), 0, GFLAGS),
	COMPOSITE_NOMUX(PCLK_PIPE, "pclk_pipe", "aclk_pipe", 0,
			RK3562_CLKSEL_CON(29), 4, 4, DFLAGS,
			RK3562_CLKGATE_CON(10), 1, GFLAGS),
	...
	GATE(ACLK_SATA1, "aclk_sata1", "aclk_pipe", 0,
			RK3562_CLKGATE_CON(11), 4, GFLAGS),
	GATE(CLK_SATA1_PMALIVE, "clk_sata1_pmalive", "gpll_20m", 0,
			RK3562_CLKGATE_CON(11), 5, GFLAGS),
	...
	COMPOSITE_NODIV(ACLK_PHP, "aclk_php", gpll300_gpll200_gpll100_xin24m_p, 0,
			RK3562_CLKSEL_CON(30), 0, 2, MFLAGS,
			RK3562_CLKGATE_CON(14), 8, GFLAGS),
	COMPOSITE_NODIV(HCLK_PHP, "hclk_php", gpll150_gpll100_gpll75_xin24m_p, 0,
			RK3562_CLKSEL_CON(30), 2, 2, MFLAGS,
			RK3562_CLKGATE_CON(14), 9, GFLAGS),
	COMPOSITE_NOMUX(PCLK_PHP, "pclk_php", "aclk_php", 0,
			RK3562_CLKSEL_CON(30), 4, 4, DFLAGS,
			RK3562_CLKGATE_CON(14), 10, GFLAGS),
	GATE(HCLK_SDMMC0, "hclk_sdmmc0", "hclk_php", 0,
			RK3562_CLKGATE_CON(15), 0, GFLAGS),
	COMPOSITE_NODIV(CLK_SDMMC0, "clk_sdmmc0", clk_sdmmc_p, 0,
			RK3562_CLKSEL_CON(30), 8, 3, MFLAGS,
			RK3562_CLKGATE_CON(15), 1, GFLAGS),
	MMC(SCLK_SDMMC0_DRV, "sdmmc0_drv", "clk_sdmmc0", RK3562_SDMMC0_CON0, 1),
	MMC(SCLK_SDMMC0_SAMPLE, "sdmmc0_sample", "clk_sdmmc0", RK3562_SDMMC0_CON1, 1),

	GATE(HCLK_SDMMC1, "hclk_sdmmc1", "hclk_php", 0,
			RK3562_CLKGATE_CON(15), 2, GFLAGS),
	COMPOSITE_NODIV(CLK_SDMMC1, "clk_sdmmc1", clk_sdmmc_p, 0,
			RK3562_CLKSEL_CON(30), 12, 3, MFLAGS,
			RK3562_CLKGATE_CON(15), 3, GFLAGS),
	MMC(SCLK_SDMMC1_DRV, "sdmmc1_drv", "clk_sdmmc1", RK3562_SDMMC1_CON0, 1),
	MMC(SCLK_SDMMC1_SAMPLE, "sdmmc1_sample", "clk_sdmmc1", RK3562_SDMMC1_CON1, 1),

	GATE(ACLK_GMAC0, "aclk_gmac0", "aclk_php", 0,
			RK3562_CLKGATE_CON(15), 5, GFLAGS),
	GATE(PCLK_GMAC0, "pclk_gmac0", "pclk_php", 0,
			RK3562_CLKGATE_CON(15), 6, GFLAGS),
	COMPOSITE_NODIV(CLK_MAC0_2TOP, "clk_mac0_2top", clk_mac_2top_p, 0,
			RK3562_CLKSEL_CON(31), 8, 2, MFLAGS,
			RK3562_CLKGATE_CON(15), 7, GFLAGS),
	COMPOSITE_NODIV(CLK_MAC0_OUT, "clk_mac0_out", cpll125_cpll50_cpll25_xin24m_p, 0,
			RK3562_CLKSEL_CON(31), 14, 2, MFLAGS,
			RK3562_CLKGATE_CON(15), 8, GFLAGS),
	GATE(CLK_MAC0_REFOUT, "clk_mac0_refout", "clk_mac0_2top", 0,
			RK3562_CLKGATE_CON(15), 12, GFLAGS),
	COMPOSITE_NODIV(CLK_GMAC0_PTP_REF, "clk_gmac0_ptp_ref", clk_gmac_ptp_p, 0,
			RK3562_CLKSEL_CON(31), 12, 2, MFLAGS,
			RK3562_CLKGATE_CON(15), 4, GFLAGS),
	MUX(SCLK_GMAC0, "clk_gmac0", mux_gmac0_p, CLK_SET_RATE_PARENT | CLK_SET_RATE_NO_REPARENT,
			RK3562_CLKSEL_CON(31), 2, 1, MFLAGS),
	...
	COMPOSITE(CLK_ISP, "clk_isp", cpll_gpll_hpll_p, 0,
			RK3562_CLKSEL_CON(35), 6, 2, MFLAGS, 0, 5, DFLAGS,
...
static const char *const rk3562_pmucru_critical_clocks[] __initconst = {
	"pclk_pdpmu",
	"pclk_pmu",
	"clk_pmu",
};

static void __init rk3562_pmu_clk_init(struct device_node *np)
{
	...
	rockchip_clk_register_plls(ctx, rk3562_pmu_pll_clks,
				   ARRAY_SIZE(rk3562_pmu_pll_clks),
				   RK3562_GRF_SOC_STATUS0);

	rockchip_clk_register_branches(ctx, rk3562_clk_pmu_branches,
				       ARRAY_SIZE(rk3562_clk_pmu_branches));

	rockchip_register_softrst(np, 1, reg_base + RK3562_PMU_SOFTRST_CON(0),
				  ROCKCHIP_SOFTRST_HIWORD_MASK);

	rockchip_clk_protect_critical(rk3562_pmucru_critical_clocks,
				      ARRAY_SIZE(rk3562_pmucru_critical_clocks));

	rockchip_clk_of_add_provider(np, ctx);
}

CLK_OF_DECLARE(rk3562_cru_pmu, "rockchip,rk3562-pmucru", rk3562_pmu_clk_init);
...
static void __init rk3562_clk_init(struct device_node *np)
{
	...
	rockchip_register_softrst(np, 30, reg_base + RK3562_SOFTRST_CON(0),
				  ROCKCHIP_SOFTRST_HIWORD_MASK);
...
static const struct clk_rk3562_inits clk_rk3562_pmucru_init = {
	.inits = rk3562_pmu_clk_init,
};
...
static const struct of_device_id clk_rk3562_match_table[] = {
	{
		...
		.data = &clk_rk3562_pmucru_init,
	},
	{ }
};

static int __init clk_rk3562_probe(struct platform_device *pdev)
{
	struct device_node *np = pdev->dev.of_node;
	const struct clk_rk3562_inits *init_data;

	init_data = (struct clk_rk3562_inits *)of_device_get_match_data(&pdev->dev);
	if (!init_data)
		return -EINVAL;
